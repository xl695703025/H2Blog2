...
public class Category {
	...
	private int categoryUserId;//分类用户Id
	...
	public String toString() {
		return "Category [categoryId=" + categoryId + ", categoryUserId="
				+ categoryUserId + ", childCategoryList=" + childCategoryList
				+ ", categoryName=" + categoryName + ", categoryDescription="
